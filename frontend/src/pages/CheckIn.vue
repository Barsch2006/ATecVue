    ...
    <v-form>
        ...
        <v-card>
            ...
            <v-card-text>
                ...
                <v-text-field v-model="technician.lastname" clearable label="Nachname" density="compact"
                    :rules="[rules.required]" />
                <v-text-field v-model="technician.position" clearable label="Position in der Schule" density="compact"
                    :rules="[rules.required]" />
                <v-text-field v-model="technician.contact" clearable label="E-Mail oder andere Kontaktmöglichkeit"
        ...
        <v-card>
            ...
            <v-card-text>
                ...
                <v-text-field clearable label="Datum der Veranstaltung" density="compact" :rules="[rules.required]" />
                <v-text-field clearable label="Uhrzeit der Veranstaltung" density="compact" :rules="[rules.required]" />
                <v-text-field clearable label="Ort der Veranstaltung" density="compact" :rules="[rules.required]" />
            </v-card-text>
        </v-card>
        ...
        <v-card>
            ...
            <v-text>
                ...
                <v-checkbox v-if="usage.backstage" label="Lichter im Backstage waren beim Betreten ausgeschaltet" />
                ...
                <v-checkbox v-if="usage.backstage" label="Schränke im Backstage waren beim Betreten verschlossen" />
                <v-checkbox v-if="usage.backstage" label="Beide Türen zum Backstage waren beim Betreten abgeschlossen" />
                ...
                <v-checkbox v-if="usage.regie" label="Regie war beim Betreten aufgeräumt, Gegenstände waren an der richtigen Position" />
                <v-checkbox label="Stühle waren beim Betreten an der rechten Wand gestapelt" />
            </v-text>
        </v-card>
